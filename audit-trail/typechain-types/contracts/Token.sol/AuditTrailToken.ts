...
export interface AuditTrailTokenInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DEFAULT_ADMIN_ROLE"
      | "DOMAIN_SEPARATOR"
...
export interface AuditTrailToken extends BaseContract {
  connect(runner?: ContractRunner | null): AuditTrailToken;
  waitForDeployment(): Promise<this>;

  interface: AuditTrailTokenInterface;
